let greetings: string = 'Hi eamonn'
...
function getHero(hero){
    return 'thor'
    //type any will allow anything here, which may mess things up. you will not get an error. i turned on noImplicitAny but it doesn't show any linting here, even tho hero is implicitly any. so it will show linting if you use an implicity any as a parameter, but not when you leave it undeclared. 
}
